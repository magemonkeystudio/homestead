...
public class DeedCommands {
    ...
    public DeedCommands(final Homestead instance) {
        ...
        if (args.argsLength() < 3) {
            if (!(sender instanceof Player)) {
                throw new CommandException(
                        "This command can only be used by players, " + "please read the command documentation.");
            }
        }
    ...
    @CommandPermissions("homestead.deeds.reload")
    ...
    @CommandPermissions("homestead.deeds.save")
