...
public class BungeePlotCommands extends Command {
    ...
    public void addPlayer(CommandSender sender, String[] args) throws BungeeCommandException {
        ...
        CordUtil.sendMessage(player, ChatColor.YELLOW + "You successfully added " + ChatColor.AQUA + playerToAdd + ChatColor.YELLOW + " to your plot.");
    ...
    public void removePlayer(CommandSender sender, String[] args) throws BungeeCommandException {
        ...
        CordUtil.sendMessage(player, ChatColor.YELLOW + "You successfully removed " + ChatColor.AQUA + playerToRemove + ChatColor.YELLOW + " from your plot.");
