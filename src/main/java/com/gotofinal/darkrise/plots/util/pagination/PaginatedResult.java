...
public abstract class PaginatedResult<T> {
    ...
    public void display(ProxiedPlayer sender, final List<? extends T> results, final int page) throws BungeeCommandException {
        if (results.isEmpty()) {
    ...
    public void display(final CommandSender sender, final Collection<? extends T> results, final int page) throws BungeeCommandException {
        this.display(sender, new ArrayList<>(results), page);
    }

    public void display(final CommandSender sender, final List<? extends T> results, final int page) throws BungeeCommandException {
        if (results.isEmpty()) {
            throw new BungeeCommandException("No results match!");
        }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).appendSuper(super.toString()).append("resultsPerPage", this.resultsPerPage).toString();
    }
}