...
public abstract class PaginatedResult<T>
{
    ...
    public void display(final CommandSender sender, final Collection<? extends T> results, final int page) throws CommandException
    {
        this.display(sender, new ArrayList<>(results), page);
    }

    public void display(final CommandSender sender, final List<? extends T> results, final int page) throws CommandException
    {
        if (results.isEmpty())
        {
