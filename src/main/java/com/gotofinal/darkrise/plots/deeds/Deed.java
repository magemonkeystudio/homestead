...
public class Deed
{
    ...
    {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).appendSuper(super.toString()).append("name", this.name).append("limitedBlocks", this.limitedBlocks).append("displayName", this.displayName).append("description", this.description).append("friends", this.friends).append("tax", this.tax).append("dropChance", this.dropChance).append("maximumExtensionTime", this.maximumExtensionTime).append("initialExtensionTime", this.initialExtensionTime).append("extensionTime", this.extensionTime).toString();
    }
}
