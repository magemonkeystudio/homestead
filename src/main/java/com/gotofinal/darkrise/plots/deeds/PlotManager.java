...
public class PlotManager
{
     ...
     */
    public PlotManager(final DarkRisePlots instance, final World world, final FileConfiguration config)
    {
    ...
    public void loadAll()
    {
        ...
        this.regionManager = WorldGuardPlugin.inst().getRegionManager(this.world);
    ...
    public Plot load(final ConfigurationSection cs, String name)
    {
        ...
        final String typeName = ConfigUtil.getOrSet(temp, "type", this.plugin.getGlobalPlotsManager().getTypes().keySet().iterator().next());
    ...
    public void save(final ConfigurationSection cs, final Plot plot)
    {
        ...
        {
            Serialization.serializeLocation(ConfigUtil.getOrCreateConfigurationSection(temp, "sign"), plot.getSignLocation(), false);
        }
        if (plot.getHome() != null)
        {
            Serialization.serializeLocation(ConfigUtil.getOrCreateConfigurationSection(temp, "home"), plot.getHome(), false);
        }
